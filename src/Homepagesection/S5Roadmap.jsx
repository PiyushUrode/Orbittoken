...
const Roadmap = () => {
    ...
    ></video>
        ...
        >
          <div className="w-full ">
            <h2 className="font-semibold bg-text-custom-gradient font-KohSantepheap bg-clip-text text-transparent mt-4 text-2xl sm:text-3xl md:text-3xl lg:text-4xl">
              Orbit Token Roadmap
            </h2>
          </div>
        </div>
        <div id="" className=" relative flex  flex-col  ">
          <div>
                ...
                >
                 <div className=" p-0.5 rounded-2xl"
                  style={{
                    ...
                    className="Sregular bg-none h-fit flex flex-col gap-5 rounded-xl roadmap-shadow tracking-wider  p-6 2xl:p-[1.5vw] 2xl:rounded-[1vw] 2xl:gap-[1.3vw]"
                    data-aos="fade-up"
                    data-aos-delay="400"
                    style={{
                 ...
                 <div className=" p-0.5 rounded-2xl"
                  ...
                  >
                    <p
                      ...
                      data-aos-delay="600"
                    >
                      Phase 2:  Ecosystem Integration and Expansion (Q2-Q3 2025)
                    </p>
 ...
 <div className=" p-0.5 rounded-2xl"
                  ...
                  >    <p
                      ...
                      data-aos-delay="600"
                    >
                      Phase 3: E-Commerce and NFT Marketplace (Q4 2025)
                    </p>
                    {/* List of steps */}
                    <div
                      className="flex gap-2"
                ...
                <div className=" p-0.5 rounded-2xl"
                  ...
                  >
                    <p
                      ...
                      data-aos-delay="600"
                    >
                      Phase 4:  Own Wallet Development (Q1-Q2 2026)
                    </p>
                    <div className="flex flex-col gap-4">
                      <div
                        className="flex gap-2 "
 ...
 <div className=" p-0.5 rounded-2xl"
                  ...
                  >    <p
                      ...
                      data-aos-delay="600"
                    >
                      Phase 5:  Own Blockchain Development (Q3 2026-Q1 2027)
                    </p>
                    {/* List of steps */}
                    <div
                      className="flex gap-2"
